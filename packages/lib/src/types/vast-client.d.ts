declare module "@dailymotion/vast-client" {
	...
	export class VASTTracker {
		...
		setProgress(progress: number, macros?: Record<string, unknown>, trackOnce?: boolean): void;
		...
		verificationNotExecuted(vendor: string, macros?: Record<string, unknown>): void;
		overlayViewDuration(formattedDuration: string, macros?: Record<string, unknown>): void;
		close(macros?: Record<string, unknown>): void;
		skip(macros?: Record<string, unknown>): void;
		load(macros?: Record<string, unknown>): void;
		click(fallbackClickThroughURL?: string | null, macros?: Record<string, unknown>): void;
		trackProgressEvents(eventName: string, macros: Record<string, unknown>, once: boolean): void;
		track(
			eventName: string,
			options?: {
