...
export class AdsLoader implements google.ima.AdsLoader {
	...
	public requestAds(adsRequest: AdsRequest, userRequestContext?: object | null): void {
		...
		if (!adTagUrl) {
			...
			this.eventEmitter.emit(google.ima.AdErrorEvent.Type.AD_ERROR, new AdErrorEvent(adError));
			return;
		}
