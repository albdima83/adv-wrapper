...
export class AdDisplayContainer implements google.ima.AdDisplayContainer {
	...
	public addEventListener(
		...
		logger.debug(TAG, `addEventListener [${type}] listener [${listener}] useCapture [${useCapture}]`);
	}
	...
	public removeEventListener(
		...
		logger.debug(TAG, `removeEventListener [${type}] listener [${listener}] useCapture [${useCapture}]`);
	}
	...
	private createAdsContainer(): HTMLElement | undefined {
		...
		const advContainer = document.getElementById("adm-adv-container") || document.createElement("div");
	...
	private createAdsSpinner(): HTMLElement | undefined {
		...
		const spinner = document.getElementById("adm-adv-spinner") || document.createElement("div");
