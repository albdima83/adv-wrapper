/* UMD | Version: 0.0.5 | Commit: d35cf5e */
(function (M, z) {
  ...
  const Pt = fe,
    ...
    Xe = class Xe {
      constructor() {
        ...
        g(this, "companionBackfill", Xe.CompanionBackfillMode.ALWAYS);
        g(this, "featureFlags", {});
        g(this, "locale", "en");
        g(this, "vpaidMode", xt.ENABLED);
      ...
      setCompanionBackfill() {
        this.companionBackfill = Pt.ALWAYS;
      }
      setCookiesEnabled(e) {
  ...
  class jr {
    ...
    log(e, r, n) {
      var i;
      if (this.enable && Vt.indexOf(e) >= Vt.indexOf(this.level)) {
  ...
  class Hr {
    ...
    initialize() {
      P.debug(He, "initialize"), this.adsContainerElement || (this.adsContainerElement = this.createAdsContainer()), this.videoAdsElement || (this.videoAdsElement = this.createAdsVideoElement()), this.adsSpinnerElement || (this.adsSpinnerElement = this.createAdsSpinner());
    }
    destroy() {
      var e, r, n;
      P.debug(He, "destroy"), (e = this.videoAdsElement) == null || e.remove(), (r = this.adsSpinnerElement) == null || r.remove(), (n = this.adsContainerElement) == null || n.remove(), this.videoAdsElement = void 0;
    }
    addEventListener(e, r, n) {
      P.debug(He, `addEventListener [${e}] listener [${r}] useCapture [${n}]`);
    }
    removeEventListener(e, r, n) {
      P.debug(He, `removeEventListener [${e}] listener [${r}] useCapture [${n}]`);
    }
    dispatchEvent(e) {
      return P.debug(He, `dispatchEvent [${e}`), !0;
    }
    getVideoAdsElement() {
  ...
  class qt {
    constructor(e, r, n, s, i, l) {
      ...
      g(this, "timeOffset");
      g(this, "totalAds");
      this.adPosition = e, this.isBumper = r, this.maxDuration = n, this.podIndex = s, this.timeOffset = i, this.totalAds = l;
    }
    getAdPosition() {
  ...
  class jt {
    ...
    addEventListener(e, r) {
      ...
      if (r === null) throw new Error("Handler cannot be null");
      this.listeners[e] || (this.listeners[e] = []);
      const i = typeof r == "function" ? r : r.handleEvent;
      if (typeof i != "function") throw new Error("Handler must be a function or have a handleEvent method");
    ...
    removeEventListener(e, r) {
      ...
      this.listeners[e] = this.listeners[e].filter(i => i.handler !== s || i.capture !== n);
    }
  ...
  function gt() {
    ...
    return {
      ...
      apiFramework: t.apiFramework || null,
      universalAdIds: [],
      creativeExtensions: []
    };
  }
  ...
  function Gt(t) {
    ...
    const n = [],
      s = $t(t);
    !e.ERRORCODE || r.isCustomCode || /^[0-9]{3}$/.test(e.ERRORCODE) || (e.ERRORCODE = 900), e.CACHEBUSTING = Xt(Math.round(1e8 * Math.random())), e.TIMESTAMP = new Date().toISOString(), e.RANDOM = e.random = e.CACHEBUSTING;
    for (const i in e) e[i] = Kt(e[i]);
    for (const i in s) {
      const l = s[i];
      typeof l == "string" && n.push(Ht(l, e));
    }
    return n;
  }
  function Ht(t, e) {
  ...
  function Yt(t, e) {
    for (let r = 0; r < e.length; r++) if (zt(e[r], t)) return !0;
    return !1;
  }
  function zt(t, e) {
    if (t && e) {
  ...
  const $ = {
    ...
    resolveURLTemplates: Gt,
    extractURLsFromTemplates: $t,
    filterUrlTemplates: function (t) {
      return t.reduce((e, r) => {
        const n = r.url || r;
        return _t(n) ? e.validUrls.push(n) : e.invalidUrls.push(n), e;
      }, {
        validUrls: [],
        invalidUrls: []
      });
    },
    containsTemplateObject: Yt,
    isTemplateObjectEqual: zt,
    encodeURIComponentRFC3986: Kt,
    replaceUrlMacros: Ht,
    ...
    joinArrayOfUniqueTemplateObjs: function () {
      ...
      const r = Array.isArray(t) ? t : [],
        n = Array.isArray(e) ? e : [];
      return r.concat(n).reduce((s, i) => (Yt(i, s) || s.push(i), s), []);
    },
  ...
  function Kr(t) {
    ...
    const s = parseInt(60 * e[1]),
      i = parseInt(60 * e[0] * 60);
    return isNaN(i) || isNaN(s) || isNaN(n) || s > 3600 || n > 60 ? -1 : i + s + n;
  }
  const m = {
    childByName: function (t, e) {
    ...
    assignAttributes: function (t, e) {
      t && Array.from(t).forEach(r => {
        ...
        if (n && s && e.hasOwnProperty(n)) {
          let i = s;
          typeof e[n] == "boolean" && (i = Qt(i)), e[n] = i;
        }
      });
    },
    mergeWrapperAdData: function (t, e) {
      ...
      const n = (e.creatives || []).filter(o => o && o.type === "companion"),
        s = n.reduce((o, c) => ((c.variations || []).forEach(h => {
          (h.companionClickTrackingURLTemplates || []).forEach(p => {
            $.containsTemplateObject(p, o) || o.push(p);
          });
        }), o), []);
      t.creatives = n.concat(t.creatives);
      const i = e.videoClickTrackingURLTemplates && e.videoClickTrackingURLTemplates.length,
        l = e.videoCustomClickURLTemplates && e.videoCustomClickURLTemplates.length;
      if (t.creatives.forEach(o => {
        if (e.trackingEvents && e.trackingEvents[o.type]) for (const c in e.trackingEvents[o.type]) {
          const h = e.trackingEvents[o.type][c];
          Array.isArray(o.trackingEvents[c]) || (o.trackingEvents[c] = []), o.trackingEvents[c] = o.trackingEvents[c].concat(h);
        }
        o.type === "linear" && (i && (o.videoClickTrackingURLTemplates = o.videoClickTrackingURLTemplates.concat(e.videoClickTrackingURLTemplates)), l && (o.videoCustomClickURLTemplates = o.videoCustomClickURLTemplates.concat(e.videoCustomClickURLTemplates)), !e.videoClickThroughURLTemplate || o.videoClickThroughURLTemplate !== null && o.videoClickThroughURLTemplate !== void 0 || (o.videoClickThroughURLTemplate = e.videoClickThroughURLTemplate)), o.type === "companion" && s.length && (o.variations || []).forEach(c => {
          c.companionClickTrackingURLTemplates = $.joinArrayOfUniqueTemplateObjs(c.companionClickTrackingURLTemplates, s);
        });
        ...
        const o = e.creatives.filter(c => {
          var h;
          return ((h = c.icons) === null || h === void 0 ? void 0 : h.length) && !c.mediaFiles.length;
        });
    ...
    return r.required = t.getAttribute("required") || null, r.variations = m.childrenByName(t, "Companion").map(n => {
      const s = function () {
        ...
        return {
          ...
          width: o.width || 0,
          height: o.height || 0,
          assetWidth: o.assetWidth || null,
          assetHeight: o.assetHeight || null,
          expandedWidth: o.expandedWidth || null,
          expandedHeight: o.expandedHeight || null,
          apiFramework: o.apiFramework || null,
          adSlotId: o.adSlotId || null,
          pxratio: o.pxratio || "1",
          renderingMode: o.renderingMode || "default",
          staticResources: [],
          htmlResources: [],
          iframeResources: [],
          adParameters: null,
      ...
      s.htmlResources = m.childrenByName(n, "HTMLResource").reduce((o, c) => {
        const h = m.parseNodeText(c);
        return h ? o.concat(h) : o;
      }, []), s.iframeResources = m.childrenByName(n, "IFrameResource").reduce((o, c) => {
        const h = m.parseNodeText(c);
        return h ? o.concat(h) : o;
      }, []), s.staticResources = m.childrenByName(n, "StaticResource").reduce((o, c) => {
        const h = m.parseNodeText(c);
        return h ? o.concat({
          url: h,
          creativeType: c.getAttribute("creativeType") || null
        }) : o;
      ...
      i && m.childrenByName(i, "Tracking").forEach(o => {
        const c = o.getAttribute("event"),
          h = m.parseNodeText(o);
        c && h && (Array.isArray(s.trackingEvents[c]) || (s.trackingEvents[c] = []), s.trackingEvents[c].push(h));
      }), s.companionClickTrackingURLTemplates = m.childrenByName(n, "CompanionClickTracking").map(o => ({
        id: o.getAttribute("id") || null,
        url: m.parseNodeText(o)
      })), s.companionClickThroughURLTemplate = m.parseNodeText(m.childByName(n, "CompanionClickThrough")) || null;
      const l = m.childByName(n, "AdParameters");
      return l && (s.adParameters = {
        value: m.parseNodeText(l),
        xmlEncoded: l.getAttribute("xmlEncoded") || null
      }), s;
    }), r;
  }
  function Qr(t, e) {
    ...
    if (s == null) n.skipDelay = null;else if (s.charAt(s.length - 1) === "%" && n.duration !== -1) {
      const c = parseInt(s, 10);
      n.skipDelay = n.duration * (c / 100);
    } else n.skipDelay = m.parseDuration(s);
    const i = m.childByName(t, "VideoClicks");
    if (i) {
      const c = m.childByName(i, "ClickThrough");
      n.videoClickThroughURLTemplate = c ? {
        id: c.getAttribute("id") || null,
        url: m.parseNodeText(c)
      } : null, m.childrenByName(i, "ClickTracking").forEach(h => {
        n.videoClickTrackingURLTemplates.push({
          id: h.getAttribute("id") || null,
          url: m.parseNodeText(h)
        });
    ...
    const l = m.childByName(t, "AdParameters");
    l && (n.adParameters = {
      value: m.parseNodeText(l),
      xmlEncoded: l.getAttribute("xmlEncoded") || null
    }), m.childrenByName(t, "TrackingEvents").forEach(c => {
      m.childrenByName(c, "Tracking").forEach(h => {
    ...
    }), m.childrenByName(t, "MediaFiles").forEach(c => {
      m.childrenByName(c, "MediaFile").forEach(y => {
      ...
      const h = m.childByName(c, "InteractiveCreativeFile");
      h && (n.interactiveCreativeFile = function (y) {
        const R = function () {
          let C = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
          return {
            type: C.type || null,
            apiFramework: C.apiFramework || null,
            variableDuration: m.parseBoolean(C.variableDuration),
            fileURL: null
          };
        }(m.parseAttributes(y));
        return R.fileURL = m.parseNodeText(y), R;
      }(h));
      const p = m.childByName(c, "ClosedCaptionFiles");
      ...
      const E = m.childByName(c, "Mezzanine"),
        v = function (y, R) {
          const C = {};
          let T = !1;
          return R.forEach(k => {
    ...
    return o && m.childrenByName(o, "Icon").forEach(c => {
      n.icons.push(function (h) {
        ...
        if (E) {
          p.iconClickThroughURLTemplate = m.parseNodeText(m.childByName(E, "IconClickThrough")), m.childrenByName(E, "IconClickTracking").forEach(y => {
            p.iconClickTrackingURLTemplates.push({
              id: y.getAttribute("id") || null,
              url: m.parseNodeText(y)
            });
          });
          const v = m.childByName(E, "IconClickFallbackImages");
          v && m.childrenByName(v, "IconClickFallbackImage").forEach(y => {
            p.iconClickFallbackImages.push({
              url: m.parseNodeText(y) || null,
              width: y.getAttribute("width") || null,
              height: y.getAttribute("height") || null
            });
          });
        }
  ...
  function Zr(t, e) {
    ...
    return m.childrenByName(t, "TrackingEvents").forEach(n => {
      let s, i;
      m.childrenByName(n, "Tracking").forEach(l => {
        s = l.getAttribute("event"), i = m.parseNodeText(l), s && i && (Array.isArray(r.trackingEvents[s]) || (r.trackingEvents[s] = []), r.trackingEvents[s].push(i));
      });
      ...
      s.id = n.getAttribute("id") || null, s.width = n.getAttribute("width"), s.height = n.getAttribute("height"), s.expandedWidth = n.getAttribute("expandedWidth"), s.expandedHeight = n.getAttribute("expandedHeight"), s.scalable = m.parseBoolean(n.getAttribute("scalable")), s.maintainAspectRatio = m.parseBoolean(n.getAttribute("maintainAspectRatio")), s.minSuggestedDuration = m.parseDuration(n.getAttribute("minSuggestedDuration")), s.apiFramework = n.getAttribute("apiFramework"), m.childrenByName(n, "HTMLResource").forEach(l => {
        s.type = l.getAttribute("creativeType") || "text/html", s.htmlResource = m.parseNodeText(l);
      }), m.childrenByName(n, "IFrameResource").forEach(l => {
        s.type = l.getAttribute("creativeType") || 0, s.iframeResource = m.parseNodeText(l);
      }), m.childrenByName(n, "StaticResource").forEach(l => {
        s.type = l.getAttribute("creativeType") || 0, s.staticResource = m.parseNodeText(l);
      });
      const i = m.childByName(n, "AdParameters");
      i && (s.adParameters = {
        value: m.parseNodeText(i),
        xmlEncoded: i.getAttribute("xmlEncoded") || null
      }), s.nonlinearClickThroughURLTemplate = m.parseNodeText(m.childByName(n, "NonLinearClickThrough")), m.childrenByName(n, "NonLinearClickTracking").forEach(l => {
        s.nonlinearClickTrackingURLTemplates.push({
          id: l.getAttribute("id") || null,
          url: m.parseNodeText(l)
        });
      }), r.variations.push(s);
    }), r;
  }
  ...
  function Jt(t) {
    ...
    if (e.name = t.nodeName, t.attributes) {
      for (const i in r) if (r.hasOwnProperty(i)) {
        const l = r[i];
        l.nodeName && l.nodeValue && (e.attributes[l.nodeName] = l.nodeValue);
      }
    }
  ...
  function er(t, e) {
    if (!it[t.nodeName] || !it[t.nodeName].attributes) return;
    const r = it[t.nodeName].attributes.filter(n => !t.getAttribute(n));
    r.length > 0 && _e({
      name: t.nodeName,
  ...
  function tr(t, e, r) {
    const n = it[t.nodeName],
      s = !r && t.nodeName !== "Wrapper";
    if (!(!n || s)) {
      if (n.subElements) {
        const i = n.subElements.filter(l => !m.childByName(t, l));
        i.length > 0 && _e({
          name: t.nodeName,
          parentName: t.parentNode.nodeName,
          subElements: i
      ...
      !r || !n.oneOfinLineResources || n.oneOfinLineResources.some(i => m.childByName(t, i)) || _e({
        name: t.nodeName,
        parentName: t.parentNode.nodeName,
  ...
  function _e(t, e) {
    let {
      ...
      o = "Element '".concat(r, "'");
    o += s ? " missing required attribute(s) '".concat(s.join(", "), "' ") : i ? " missing required sub element(s) '".concat(i.join(", "), "' ") : l ? " must provide one of the following '".concat(l.join(", "), "' ") : " is empty", e("VAST-warning", {
      message: o,
      parentElement: n,
      specVersion: 4.1
    });
  ...
  const en = {
    verifyRequiredValues: function t(e, r, n) {
      ...
      } else m.parseNodeText(e).length === 0 && _e({
        name: e.nodeName,
        parentName: e.parentNode.nodeName
      }, r);
    },
    hasSubElements: rr,
    emitMissingValueWarning: _e,
  ...
  function tn(t, e) {
    ...
    for (const i of s) {
      ...
      const l = i.nodeName.toLowerCase();
      e("VAST-warning", {
        message: "<".concat(i.nodeName, l === "inline" ? "> must be written <InLine>" : "> must be written <Wrapper>"),
        wrongNode: i
      });
    }
  }
    ...
    return n.forEach(i => {
      switch (i.nodeName) {
        case "Error":
          ...
          break;
        case "Impression":
          s.impressionURLTemplates.push({
            id: i.getAttribute("id") || null,
            url: m.parseNodeText(i)
          });
          break;
        case "Creatives":
          s.creatives = function (l) {
            const o = [];
            return l.forEach(c => {
              const h = {
                  id: c.getAttribute("id") || null,
                ...
                p = [];
              let E;
              m.childrenByName(c, "UniversalAdId").forEach(y => {
                const R = {
                  idRegistry: y.getAttribute("idRegistry") || "unknown",
                  value: m.parseNodeText(y)
                };
                p.push(R);
              });
              const v = m.childByName(c, "CreativeExtensions");
              v && (E = Zt(m.childrenByName(v, "CreativeExtension")));
              for (const y in c.childNodes) {
                const R = c.childNodes[y];
                let C;
                switch (R.nodeName) {
                  case "Linear":
                    C = Qr(R, h);
        ...
        case "Extensions":
          {
            const l = m.childrenByName(i, "Extension");
            s.extensions = Zt(l), s.adVerifications.length || (r = function (o) {
              let c = null,
                h = [];
              return o.some(p => c = m.childByName(p, "AdVerifications")), c && (h = ir(m.childrenByName(c, "Verification"))), h;
            }(l));
            break;
          }
        case "AdVerifications":
          s.adVerifications = ir(m.childrenByName(i, "Verification"));
          break;
        case "AdSystem":
          s.system = {
            value: m.parseNodeText(i),
        ...
        case "Category":
          s.categories.push({
            authority: i.getAttribute("authority") || null,
            value: m.parseNodeText(i)
          });
          break;
        case "Expires":
        ...
        case "ViewableImpression":
          s.viewableImpression.push(function (l) {
            const o = (c, h) => {
            ...
            return {
              id: l.getAttribute("id") || null,
              viewable: m.childrenByName(l, "Viewable").reduce(o, []),
              notViewable: m.childrenByName(l, "NotViewable").reduce(o, []),
              viewUndetermined: m.childrenByName(l, "ViewUndetermined").reduce(o, [])
            };
          }(i));
          break;
        case "Description":
  ...
  function nn(t, e) {
    const r = nr(t, e),
      ...
      i = t.getAttribute("fallbackOnNoAd");
    ...
    let l = m.childByName(t, "VASTAdTagURI");
    if (l ? r.nextWrapperURL = m.parseNodeText(l) : (l = m.childByName(t, "VASTAdTagURL"), l && (r.nextWrapperURL = m.parseNodeText(m.childByName(l, "URL")))), r.creatives.forEach(o => {
      if (["linear", "nonlinear"].includes(o.type)) {
        if (o.trackingEvents) {
          r.trackingEvents || (r.trackingEvents = {}), r.trackingEvents[o.type] || (r.trackingEvents[o.type] = {});
          for (const c in o.trackingEvents) {
            const h = o.trackingEvents[c];
            Array.isArray(r.trackingEvents[o.type][c]) || (r.trackingEvents[o.type][c] = []), h.forEach(p => {
              r.trackingEvents[o.type][c].push(p);
            });
          }
        }
        o.videoClickTrackingURLTemplates && (Array.isArray(r.videoClickTrackingURLTemplates) || (r.videoClickTrackingURLTemplates = []), o.videoClickTrackingURLTemplates.forEach(c => {
          r.videoClickTrackingURLTemplates.push(c);
        })), o.videoClickThroughURLTemplate && (r.videoClickThroughURLTemplate = o.videoClickThroughURLTemplate), o.videoCustomClickURLTemplates && (Array.isArray(r.videoCustomClickURLTemplates) || (r.videoCustomClickURLTemplates = []), o.videoCustomClickURLTemplates.forEach(c => {
          r.videoCustomClickURLTemplates.push(c);
        }));
      }
  ...
  function ir(t) {
    ...
    return t.forEach(r => {
      const n = {
        ...
        s = Array.from(r.childNodes);
      m.assignAttributes(r.attributes, n), s.forEach(l => {
        let {
          nodeName: o,
          textContent: c,
          attributes: h
        ...
        switch (o) {
          ...
          case "ExecutableResource":
            n.resource = c.trim(), m.assignAttributes(h, n);
            break;
      ...
      i && m.childrenByName(i, "Tracking").forEach(l => {
        const o = l.getAttribute("event"),
          c = m.parseNodeText(l);
        o && c && (Array.isArray(n.trackingEvents[o]) || (n.trackingEvents[o] = []), n.trackingEvents[o].push(c));
      }), e.push(n);
    }), e;
  }
  class sr {
    ...
    once(e, r) {
      return this.on(e, function (n, s, i) {
        ...
        function o() {
          l.fired || (n.off(s, l.wrapFn), l.fired = !0, i.bind(n)(...arguments));
        }
        return l.wrapFn = o, o;
      }(this, e, r));
    }
    ...
    emit(e) {
      ...
      let i = !1;
      return this._handlers.forEach(l => {
        l.event === "*" && (i = !0, l.handler(e, ...n)), l.event === e && (i = !0, l.handler(...n));
      }), i;
    }
  ...
  const ar = (t, e) => {
    ...
    or = "VAST response version not supported";
  class lr extends sr {
    constructor() {
      let {
        fetcher: e
    ...
    initParsingStatus() {
      ...
      }, this.rootURL = "", this.resetParsingStatus(), ar(e.byteLength, e.requestDuration);
    }
    resetParsingStatus() {
    ...
    getRemainingAds(e) {
      ...
      return this.errorURLTemplates = [], this.resolveAds(r, {
        wrapperDepth: 0,
        url: this.rootURL
      }).then(n => this.buildVASTResponse(n));
    }
    parseVAST(e) {
    ...
    parseVastXml(e, r) {
      ...
      if (!e || !e.documentElement || e.documentElement.nodeName !== "VAST") {
        ...
        const v = (e == null || (c = e.documentElement) === null || c === void 0 ? void 0 : c.nodeName) === "VideoAdServingTemplate";
        throw new Error(v ? or : "Invalid VAST XMLDocument");
      }
      const h = [],
        p = e.documentElement.childNodes,
        E = e.documentElement.getAttribute("version");
      ...
      for (const v in p) {
        ...
        if (y.nodeName === "Error") {
          ...
          R.ad ? (h.push(R.ad), this.emit("VAST-ad-parsed", {
            type: R.type,
            url: s,
            wrapperDepth: i,
            adIndex: h.length - 1,
    ...
    parse(e) {
      ...
      if (p.length === 1 && s != null && (p[0].sequence = s), n === !1) {
        const E = m.getSortedAdPods(p),
          v = m.getStandAloneAds(p);
        E.length ? p = E : v.length && (p = [v.shift()]), this.remainingAds = v;
      }
      return this.resolveAds(p, {
        wrapperDepth: l,
        previousUrl: i,
        url: r
      });
    ...
    resolveAds() {
      ...
      const i = [];
      return n = s, e.forEach(l => {
        const o = this.resolveWrappers(l, r, n);
        i.push(o);
      }), Promise.all(i).then(l => $.flatten(l));
    }
    resolveWrappers(e, r, n) {
      ...
      return new Promise(i => {
        ...
        const o = (l = this.parsingOptions.allowMultipleAds) !== null && l !== void 0 ? l : s.allowMultipleAds,
          c = s.sequence;
        this.fetcher.fetchVAST({
          url: s.nextWrapperURL,
          ...
          s.errorCode = h.message === or ? 102 : 301, s.errorMessage = h.message, i(s);
        });
      });
    }
    completeWrapperResolving(e) {
      if (e.ads.length === 0) this.trackVastError(e.errorURLTemplates, {
        ERRORCODE: 303
      });else for (let r = e.ads.length - 1; r >= 0; r--) {
        const n = e.ads[r],
          s = !n.creatives.some(i => {
            var l, o;
            return ((l = i.mediaFiles) === null || l === void 0 ? void 0 : l.length) > 0 || ((o = i.variations) === null || o === void 0 ? void 0 : o.length) > 0;
          });
        !n.errorCode && !s || n.VASTAdTagURI || (this.trackVastError(n.errorURLTemplates.concat(e.errorURLTemplates), {
  ...
  class an {
    ...
    initStorage() {
      if (ge) return ge;
      try {
        ge = typeof window != "undefined" && window !== null ? window.localStorage || window.sessionStorage : null;
      } catch (e) {
        ge = null;
      }
        ...
        return Oe(this, null, function* () {
          try {
            const r = new AbortController(),
              ...
              i = function (l) {
                return $.isBrowserEnvironment() && window.location.protocol === "https:" && l.url.includes("http://") ? "URLHandler: Cannot go from HTTPS to HTTP." : l.status === 200 && l.ok ? null : "URLHandler: ".concat(l.statusText, " (").concat(l.status, ")");
              }(s);
            return i ? {
              error: new Error(i),
              statusCode: s.status
            ...
            return {
              error: r,
              statusCode: r.name === "AbortError" ? 408 : null
            };
          }
        });
      }
  ...
  class ln {
    ...
    fetchVAST(e) {
      return Oe(this, null, function* () {
        ...
        const p = yield this.urlHandler.get(n, this.fetchingOptions),
          E = Math.round(Date.now() - h);
        if (i("VAST-resolved", qe({
          url: n,
          previousUrl: o,
          wrapperDepth: l,
          error: (p == null ? void 0 : p.error) || null,
          duration: E,
          statusCode: (p == null ? void 0 : p.statusCode) || null
        }, p == null ? void 0 : p.details)), ar(p == null || (r = p.details) === null || r === void 0 ? void 0 : r.byteLength, E), p.error) throw new Error(p.error);
        return p.xml;
      });
    }
  }
  class cn {
    ...
    get(e) {
      ...
      return r.hasOwnProperty("resolveAll") || (r.resolveAll = !1), this.totalCallsTimeout < n ? (this.totalCalls = 1, this.totalCallsTimeout = n + 36e5) : this.totalCalls++, new Promise((s, i) => {
        ...
        const l = n - this.lastSuccessfulAd;
        if (l < 0) this.lastSuccessfulAd = 0;else if (l < this.cappingMinimumTimeInterval) return i(new Error("VAST call canceled – (".concat(this.cappingMinimumTimeInterval, ")ms minimum interval reached")));
        this.vastParser.initParsingStatus(r), this.fetcher.setOptions(r), this.vastParser.rootURL = e, this.fetcher.fetchVAST({
          url: e,
          emitter: this.vastParser.emit.bind(this.vastParser),
          maxWrapperDepth: this.vastParser.maxWrapperDepth
        }).then(o => (r.previousUrl = e, r.isRootVAST = !0, r.url = e, this.vastParser.parse(o, r).then(c => {
          const h = this.vastParser.buildVASTResponse(c);
          s(h);
        }))).catch(o => i(o));
      });
    }
  ...
  class dn extends sr {
    constructor(e, r, n) {
      ...
      for (const l in this.creative.trackingEvents) {
        const o = this.creative.trackingEvents[l];
        this.trackingEvents[l] = o.slice(0);
      }
      (function (l) {
    ...
    setDuration(e) {
      $.isValidTimeValue(e) ? (this.assetDuration = e, this.quartiles = {
    ...
    setProgress(e) {
      ...
      if (!$.isValidTimeValue(e) || typeof r != "object") return void this.emit("TRACKER-error", {
        message: "One given setProgress parameter has the wrong type. progress: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
      ...
      if (s === -1 || this.skippable || (s > e ? this.emit("skip-countdown", s - e) : (this.skippable = !0, this.emit("skip-countdown", 0))), this.assetDuration > 0) {
        const i = Math.round(e / this.assetDuration * 100),
          l = [];
        if (e > 0) {
          l.push("start");
          for (let o = this.lastPercentage; o < i; o++) l.push("progress-".concat(o + 1, "%"));
          l.push("progress-".concat(e));
          for (const o in this.quartiles) this.isQuartileReached(o, this.quartiles[o], e) && (l.push(o), this._alreadyTriggeredQuartiles[o] = !0);
    ...
    setMuted(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      typeof e == "boolean" && typeof r == "object" ? (this.muted !== e && this.track(e ? "mute" : "unmute", {
        macros: r
      }), this.muted = e) : this.emit("TRACKER-error", {
        message: "One given setMuted parameter has the wrong type. muted: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
    }
    setPaused(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      typeof e == "boolean" && typeof r == "object" ? (this.paused !== e && this.track(e ? "pause" : "resume", {
        macros: r
      }), this.paused = e) : this.emit("TRACKER-error", {
        message: "One given setPaused parameter has the wrong type. paused: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
    }
    setFullscreen(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      typeof e == "boolean" && typeof r == "object" ? (this.fullscreen !== e && this.track(e ? "fullscreen" : "exitFullscreen", {
        macros: r
      }), this.fullscreen = e) : this.emit("TRACKER-error", {
        message: "One given setFullScreen parameter has the wrong type. fullscreen: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
    }
    setExpand(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      typeof e == "boolean" && typeof r == "object" ? (this.expanded !== e && (this.track(e ? "expand" : "collapse", {
        macros: r
      }), this.track(e ? "playerExpand" : "playerCollapse", {
        macros: r
      })), this.expanded = e) : this.emit("TRACKER-error", {
        message: "One given setExpand parameter has the wrong type. expanded: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
    }
    setSkipDelay(e) {
      $.isValidTimeValue(e) ? this.skipDelay = e : this.emit("TRACKER-error", {
        message: "setSkipDelay parameter does not have a valid value. duration: ".concat(e)
      });
    }
    trackImpression() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.impressed || (this.impressed = !0, this.trackURLs(this.ad.impressionURLTemplates, e), this.track("creativeView", {
        macros: e
      })) : this.emit("TRACKER-error", {
    ...
    error() {
      ...
      typeof e == "object" && typeof r == "boolean" ? this.trackURLs(this.ad.errorURLTemplates, e, {
        isCustomCode: r
      }) : this.emit("TRACKER-error", {
        message: "One given error parameter has the wrong type. macros: ".concat($.formatMacrosValues(e), ", isCustomCode: ").concat(r)
      });
    }
    errorWithCode(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 && arguments[1];
      typeof e == "string" && typeof r == "boolean" ? (this.error({
        ERRORCODE: e
      }, r), console.log("The method errorWithCode is deprecated, please use vast tracker error method instead")) : this.emit("TRACKER-error", {
        message: "One given errorWithCode parameter has the wrong type. errorCode: ".concat(e, ", isCustomCode: ").concat(r)
      });
    }
    complete() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("complete", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    notUsed() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? (this.track("notUsed", {
        macros: e
    ...
    otherAdInteraction() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("otherAdInteraction", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    acceptInvitation() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("acceptInvitation", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    adExpand() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("adExpand", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    adCollapse() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("adCollapse", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    minimize() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("minimize", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    verificationNotExecuted(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      if (typeof e != "string" || typeof r != "object") return void this.emit("TRACKER-error", {
        message: "One given verificationNotExecuted parameter has to wrong type. vendor: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
      ...
      if (s && s.verificationNotExecuted) {
        ...
        this.trackURLs(i, r), this.emit("verificationNotExecuted", {
    ...
    overlayViewDuration(e) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      typeof e == "string" && typeof r == "object" ? (r.ADPLAYHEAD = e, this.track("overlayViewDuration", {
        macros: r
      })) : this.emit("TRACKER-error", {
        message: "One given overlayViewDuration parameters has the wrong type. formattedDuration: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
    }
    close() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track(this.linear ? "closeLinear" : "close", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    skip() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("skip", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    load() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      typeof e == "object" ? this.track("loaded", {
        macros: e
      }) : this.emit("TRACKER-error", {
    ...
    click() {
      let e = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : null,
        r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
      if (e !== null && typeof e != "string" || typeof r != "object") return void this.emit("TRACKER-error", {
        message: "One given click parameter has the wrong type. fallbackClickThroughURL: ".concat(e, ", macros: ").concat($.formatMacrosValues(r))
      });
      this.clickTrackingURLTemplates && this.clickTrackingURLTemplates.length && this.trackURLs(this.clickTrackingURLTemplates, r);
      const n = this.clickThroughURLTemplate || e,
        s = qe({}, r);
      if (n) {
        this.progress && (s.ADPLAYHEAD = this.progressFormatted());
        const i = $.resolveURLTemplates([n], s)[0];
    ...
    trackProgressEvents(e, r, n) {
      ...
      Object.entries(this.trackingEvents).filter(i => {
        let [l] = i;
        return l.startsWith("progress-");
      }).map(i => {
        let [l, o] = i;
        return {
          name: l,
          time: parseFloat(l.split("-")[1]),
          urls: o
        };
      }).filter(i => {
        let {
        ...
        return l <= s && l > this.progress;
      }).forEach(i => {
        let {
          name: l,
          urls: o
        } = i;
        !n && this.trackedProgressEvents.includes(l) || (this.emit(l, {
          trackingURLTemplates: o
        }), this.trackURLs(o, r), n ? delete this.trackingEvents[l] : this.trackedProgressEvents.push(l));
      });
    }
    track(e) {
      let {
      ...
      if (typeof r != "object") return void this.emit("TRACKER-error", {
        message: "track given macros has the wrong type. macros: ".concat(r)
      });
      ...
      const s = this.trackingEvents[e],
        i = this.emitAlwaysEvents.indexOf(e) > -1;
      s ? (this.emit(e, {
        trackingURLTemplates: s
      }), this.trackURLs(s, r)) : i && this.emit(e, null), n && (delete this.trackingEvents[e], i && this.emitAlwaysEvents.splice(this.emitAlwaysEvents.indexOf(e), 1));
    }
    trackURLs(e) {
      var r;
  ...
  function An(t, e) {
    ...
    for (let i = 0; i < t.length; i++) if (t[i] === "<" && t[i + 1] === "?") {
      if (i += 2, i = pr(t, i), i.err) return i;
    } else if (t[i] === "<") {
      let l = i;
      if (i++, t[i] === "!") {
        i = fr(t, i);
...
` && t[i] !== "\r"; i++) c += t[i];
        ...
        if (i = h.index, p[p.length - 1] === "/") {
          ...
          const v = mr(p, e);
          if (v === !0) n = !0;else return X(v.err.code, v.err.msg, ue(t, E + v.err.line));
        } else if (o) {
          if (h.tagClosed) {
            if (p.trim().length > 0) return X("InvalidTag", "Closing tag '" + c + "' can't have attributes or invalid starting.", ue(t, l));
            if (r.length === 0) return X("InvalidTag", "Closing tag '" + c + "' has not been opened.", ue(t, l));
            {
              const E = r.pop();
              if (c !== E.tagName) {
                let v = ue(t, E.tagStartPos);
                return X("InvalidTag", "Expected closing tag '" + E.tagName + "' (opened in line " + v.line + ", col " + v.col + ") instead of closing tag '" + c + "'.", ue(t, l));
              }
              r.length == 0 && (s = !0);
            }
          } else return X("InvalidTag", "Closing tag '" + c + "' doesn't have proper closing.", ue(t, i));
        } else {
          const E = mr(p, e);
          if (E !== !0) return X(E.err.code, E.err.msg, ue(t, i - p.length + E.err.line));
          if (s === !0) return X("InvalidXml", "Multiple possible root nodes found.", ue(t, i));
          e.unpairedTags.indexOf(c) !== -1 || r.push({
            tagName: c,
            tagStartPos: l
          }), n = !0;
        }
        for (i++; i < t.length; i++) if (t[i] === "<") {
          if (t[i + 1] === "!") {
            i++, i = fr(t, i);
            continue;
          } else if (t[i + 1] === "?") {
      ...
      if (hr(t[i])) continue;
      return X("InvalidChar", "char '" + t[i] + "' is not expected.", ue(t, i));
    }
    if (n) {
      if (r.length == 1) return X("InvalidTag", "Unclosed tag '" + r[0].tagName + "'.", ue(t, r[0].tagStartPos));
      if (r.length > 0) return X("InvalidXml", "Invalid '" + JSON.stringify(r.map(i => i.tagName), null, 4).replace(/\r?\n/g, "") + "' found.", {
        line: 1,
        col: 1
      });
...
` || t === "\r";
  ...
  function pr(t, e) {
    ...
    for (; e < t.length; e++) if (t[e] == "?" || t[e] == " ") {
      ...
      if (e > 5 && n === "xml") return X("InvalidXml", "XML declaration allowed only at the start of the document.", ue(t, e));
      if (t[e] == "?" && t[e + 1] == ">") {
        e++;
        break;
      } else continue;
  ...
  function fr(t, e) {
    if (t.length > e + 5 && t[e + 1] === "-" && t[e + 2] === "-") {
      ...
      let r = 1;
      for (e += 8; e < t.length; e++) if (t[e] === "<") r++;else if (t[e] === ">" && (r--, r === 0)) break;
  ...
  function Sn(t, e) {
    ...
    if (Tt(r), e = De(t, e), t.substring(e, e + 6).toUpperCase() === "SYSTEM") throw new Error("External entities are not supported");
  ...
  function Ln(t, e) {
    ...
    if (n !== "SYSTEM" && n !== "PUBLIC") throw new Error(`Expected SYSTEM or PUBLIC, found "${n}"`);
    e += n.length, e = De(t, e);
    let s = null,
      i = null;
    if (n === "PUBLIC") [e, s] = ut(t, e, "publicIdentifier"), e = De(t, e), (t[e] === '"' || t[e] === "'") && ([e, i] = ut(t, e, "systemIdentifier"));else if (n === "SYSTEM" && ([e, i] = ut(t, e, "systemIdentifier"), !i)) throw new Error("Missing mandatory system identifier for SYSTEM notation");
    return {
      notationName: r,
      publicIdentifier: s,
      systemIdentifier: i,
  ...
  function ut(t, e, r) {
    ...
    for (e++; e < t.length && t[e] !== s;) n += t[e], e++;
  ...
  function kn(t, e) {
    ...
    let r = "";
    for (; e < t.length && !/\s/.test(t[e]);) r += t[e], e++;
    if (!Tt(r)) throw new Error(`Invalid element name: "${r}"`);
    if (e = De(t, e), t[e] !== "(") throw new Error(`Expected '(', found "${t[e]}"`);
    e++;
    let n = "";
    for (; e < t.length && t[e] !== ")";) n += t[e], e++;
  ...
  function qn(t) {
    ...
    if (r.search(/[eE]/) !== -1) {
      ...
      if (n) {
        if (e.leadingZeros) r = (n[1] || "") + n[3];else if (!(n[2] === "0" && n[3][0] === ".")) return t;
      ...
      if (n) {
        ...
        if (e.leadingZeros && i === t) return 0;
        {
          const o = Number(r),
            c = "" + o;
          return c.search(/[eE]/) !== -1 ? e.eNotation ? o : t : r.indexOf(".") !== -1 ? c === "0" && l === "" || c === l || s && c === "-" + l ? o : t : i ? l === c || s + l === c ? o : t : r === c || r === s + c ? o : t;
        }
      } else return t;
    }
  }
  ...
  class Wn {
    constructor(e) {
      this.options = e, this.currentNode = null, this.tagsNodeStack = [], this.docTypeEntities = {}, this.lastEntities = {
        ...
        num_dec: {
          regex: /&#([0-9]{1,7});/g,
          val: (r, n) => String.fromCodePoint(Number.parseInt(n, 10))
        },
        num_hex: {
  ...
  function Kn(t, e, r) {
    if (this.options.ignoreAttributes !== !0 && typeof t == "string") {
      const n = dr(t, zn),
        ...
        i = {};
      for (let l = 0; l < s; l++) {
        const o = this.resolveNameSpace(n[l][1]);
        if (this.ignoreAttributesFn(o, e)) continue;
        let c = n[l][4],
          h = this.options.attributeNamePrefix + o;
        if (o.length) if (this.options.transformAttributeName && (h = this.options.transformAttributeName(h)), h === "__proto__" && (h = "#__proto__"), c !== void 0) {
          this.options.trimValues && (c = c.trim()), c = this.replaceEntitiesValue(c);
          const p = this.options.attributeValueProcessor(o, c, e);
          p == null ? i[h] = c : typeof p != typeof c || p !== c ? i[h] = p : i[h] = bt(c, this.options.parseAttributeValue, this.options.numberParseOptions);
...
`);
    ...
    for (let i = 0; i < t.length; i++) if (t[i] === "<") {
      if (t[i + 1] === "/") {
        const o = Ne(t, ">", i, "Closing Tag is not closed.");
        let c = t.substring(i + 2, o).trim();
        if (this.options.removeNSPrefix) {
          const E = c.indexOf(":");
          E !== -1 && (c = c.substr(E + 1));
        }
        ...
        if (n = this.saveTextToParentTag(n, r, s), !(this.options.ignoreDeclaration && o.tagName === "?xml" || this.options.ignorePiTags)) {
          const c = new Ce(o.tagName);
          c.add(this.options.textNodeName, ""), o.tagName !== o.tagExp && o.attrExpPresent && (c[":@"] = this.buildAttributesMap(o.tagExp, s, o.tagName)), this.addChild(r, c, s, i);
        }
        i = o.closeIndex + 1;
      } else if (t.substr(i + 1, 3) === "!--") {
        const o = Ne(t, "-->", i + 4, "Comment is not closed.");
        if (this.options.commentPropName) {
          const c = t.substring(i + 4, o - 2);
        ...
        let h = this.parseTextData(c, r.tagname, s, !0, !1, !0, !0);
        h == null && (h = ""), this.options.cdataPropName ? r.add(this.options.cdataPropName, [{
          [this.options.textNodeName]: c
        }]) : r.add(this.options.textNodeName, h), i = o + 2;
      } else {
        let o = Dt(t, i, this.options.removeNSPrefix),
          c = o.tagName;
        ...
        const y = r;
        y && this.options.unpairedTags.indexOf(y.tagname) !== -1 && (r = this.tagsNodeStack.pop(), s = s.substring(0, s.lastIndexOf("."))), c !== e.tagname && (s += s ? "." + c : c);
        const R = i;
        if (this.isItStopNode(this.options.stopNodes, s, c)) {
          let C = "";
          if (p.length > 0 && p.lastIndexOf("/") === p.length - 1) c[c.length - 1] === "/" ? (c = c.substr(0, c.length - 1), s = s.substr(0, s.length - 1), p = c) : p = p.substr(0, p.length - 1), i = o.closeIndex;else if (this.options.unpairedTags.indexOf(c) !== -1) i = o.closeIndex;else {
            const k = this.readStopNodeData(t, h, v + 1);
            if (!k) throw new Error(`Unexpected end of ${h}`);
            i = k.i, C = k.tagContent;
          }
          const T = new Ce(c);
          c !== p && E && (T[":@"] = this.buildAttributesMap(p, s, c)), C && (C = this.parseTextData(C, c, s, !0, E, !0, !0)), s = s.substr(0, s.lastIndexOf(".")), T.add(this.options.textNodeName, C), this.addChild(r, T, s, R);
        } else {
          if (p.length > 0 && p.lastIndexOf("/") === p.length - 1) {
            c[c.length - 1] === "/" ? (c = c.substr(0, c.length - 1), s = s.substr(0, s.length - 1), p = c) : p = p.substr(0, p.length - 1), this.options.transformTagName && (c = this.options.transformTagName(c));
            const C = new Ce(c);
            c !== p && E && (C[":@"] = this.buildAttributesMap(p, s, c)), this.addChild(r, C, s, R), s = s.substr(0, s.lastIndexOf("."));
          } else {
            const C = new Ce(c);
            this.tagsNodeStack.push(r), c !== p && E && (C[":@"] = this.buildAttributesMap(p, s, c)), this.addChild(r, C, s, R), r = C;
          }
          n = "", i = v;
        }
      }
  ...
  function ti(t, e) {
    ...
    for (let i = e; i < t.length; i++) {
      let l = t[i];
      if (n) l === n && (n = "");else if (l === '"' || l === "'") n = l;else if (l === r[0]) {
        if (r[1]) {
          if (t[i + 1] === r[1]) return {
            data: s,
            index: i
  ...
  function Dt(t, e, r) {
    ...
    let c = i,
      h = !0;
    o !== -1 && (c = i.substring(0, o), i = i.substring(o + 1).trimStart());
    const p = c;
    if (r) {
      const E = c.indexOf(":");
      E !== -1 && (c = c.substr(E + 1), h = c !== s.data.substr(E + 1));
    }
    return {
      tagName: c,
      tagExp: i,
  ...
  function ri(t, e, r) {
    ...
    for (; r < t.length; r++) if (t[r] === "<") if (t[r + 1] === "/") {
      const i = Ne(t, ">", r, `${e} is not closed`);
      if (t.substring(r + 2, i).trim() === e && (s--, s === 0)) return {
        tagContent: t.substring(n, r),
        i
      };
      r = i;
    } else if (t[r + 1] === "?") r = Ne(t, "?>", r + 1, "StopNode is not closed.");else if (t.substr(r + 1, 3) === "!--") r = Ne(t, "-->", r + 3, "StopNode is not closed.");else if (t.substr(r + 1, 2) === "![") r = Ne(t, "]]>", r, "StopNode is not closed.") - 2;else {
      const i = Dt(t, r, ">");
  ...
  class vr {
    ...
    init(e, r, n, s) {
      P.debug(_, `init width[${e}] height[${r}] viewMode[${n}] videoElement[${s}]`);
    }
    isCustomClickTrackingUsed() {
      return P.debug(_, "isCustomClickTrackingUsed"), !1;
    }
    isCustomPlaybackUsed() {
      return P.debug(_, "isCustomPlaybackUsed"), !0;
    }
    pause() {
      P.debug(_, "pause");
    }
    resize(e, r, n) {
      P.debug(_, `resize width[${e}] height[${r}] viewMode[${n}]`);
    }
    resume() {
      P.debug(_, "resume");
    }
    ...
    skip() {
      ...
      const e = this.adDisplayContainer.getVideoAdsElement(),
        r = ((n = this.currentCreative) == null ? void 0 : n.skipDelay) || 0;
      if (!(!e || r <= 0 || this.adRemainingTime > r && this.adRemainingTime < this.adDuration)) try {
        e.pause();
      } finally {
        P.debug(_, "video user skipped"), (s = this.vastTracker) == null || s.skip(), this.dispatchAdsEvent(google.ima.AdEvent.Type.SKIPPED), this.playCreativities();
      }
    }
    start() {
    ...
    updateAdsRenderingSettings(e) {
      P.debug(_, `updateAdsRenderingSettings [${e}]`);
    }
    ...
    dispatchEvent(e) {
      return P.debug(_, `dispatchEvent: [${e}]`), !0;
    }
    fetchAds() {
      ...
      return fetch(e).then(r => r.text()).then(r => Oe(this, null, function* () {
        ...
        const n = new ai({
          ...
          s = n.parse(r);
        if (!s) return Promise.reject(new Error("Invalid XML response"));
        if (s.VAST) {
          const o = new globalThis.DOMParser().parseFromString(r, "text/xml"),
            h = yield new lr().parseVAST(o),
            p = [];
          let E = 0,
            v = 0;
          P.debug(_, `fetchVastAds: [${e}]: `, h);
          ...
          this.nextAds = p, this.totalAds = v, this.totalTimeAds = E, P.debug(_, `fetchVastAds totalAds: [${v}] [${E}]`);
        } else {
          const o = n.parse(r),
            c = o == null ? void 0 : o["vmap:VMAP"]["vmap:AdBreak"];
          if (!c) return this;
          if (Array.isArray(c)) c.forEach(h => {
            const p = h["@_timeOffset"];
            if (p) {
              const E = Ar(p);
              if (!isNaN(E) && this.isValidAdBreak(h)) {
                P.debug(_, `vmap adBreak timeOffset [${p}]:`, E), this.cuePoints.includes(E) || this.cuePoints.push(E);
                const v = this.cueMapPoints[E] || [];
                v.push(h), this.cueMapPoints[E] = v;
              }
            }
          });else {
            const h = c["@_timeOffset"];
            if (h) {
              const p = Ar(h);
              !isNaN(p) && this.isValidAdBreak(c) && (this.cuePoints.push(p), this.cueMapPoints[p] = [c]);
            }
          }
        }
    ...
    playCreativities() {
      ...
      if (this.currentCreative = void 0, this.currentAdVast && this.queueCreatives.length > 0) {
        ...
        if (!n) return this.playCreativities();
        ...
        if (s && s.length > 0) for (const i of s) {
          ...
          if (l && l.startsWith("video/mp4") && i.fileURL) {
            ...
            P.debug(_, `current podInfo: [${o}] [${this.totalTimeAds}] [${this.totalAds}]`), this.currentAd = new Mt(this.currentAdVast, n, i, c), e || this.dispatchAdsEvent(google.ima.AdEvent.Type.CONTENT_PAUSE_REQUESTED), this.playAdsContent(i.fileURL).catch(h => {
              P.error(_, "playAdsContent error: ", h);
            });
            return;
          }
        }
    ...
    handleContentTimeUpdate() {
      ...
      if (!this.isValidContentObject(e) || this.cuePoints.length === 0 || this.processingAdv) return;
      if (this.nextAds && this.nextAds.length > 0) {
    ...
    getAdValidCreative(e) {
      const r = e.creatives;
      if (r && r.length > 0) {
        for (const n of r) if (n.type === "linear") {
          const l = n.mediaFiles;
          if (l && l.length > 0) for (const o of l) {
            const c = (o.mimeType || "").toLowerCase();
            if (c && c === "video/mp4" && o.fileURL) return n;
          }
        }
      }
    }
    getCreativities(e) {
      const r = [],
        n = e.creatives;
      if (n && n.length > 0) {
        for (const s of n) if (s.type === "linear") {
          const o = s.mediaFiles;
          if (o && o.length > 0) for (const c of o) {
            const h = c.mimeType;
            if (h && h.startsWith("video/mp4") && c.fileURL) {
              r.push(s);
              break;
            }
          }
    ...
    trackingEvent(e) {
      ...
      if (!r) return;
      const n = r.trackingEvents,
        s = n == null ? void 0 : n[e];
      if (s) for (const i of s) this.trackUrl(i);
    }
    trackUrl(e) {
      try {
        if (globalThis) {
      ...
      return Oe(this, null, function* () {
        ...
        if (this.started) try {
          ...
          if (l) {
            ...
            for (const v of E) if (v.status === "fulfilled") {
              const y = v.value,
                R = (s = y == null ? void 0 : y.ads) != null ? s : void 0;
              if (R && R.length > 0) for (const C of R) {
                const T = this.getAdValidCreative(C);
                T && (p.push(C), c += T.duration || 0, h += 1);
              } else (i = y.errorURLTemplates) == null || i.forEach(C => {
                this.trackUrl(C);
              });
            }
            this.nextAds = p, this.totalAds = h, this.totalTimeAds = c, P.debug(_, `fetchVastAds totalAds: [${h}] [${c}]`), !this.nextAds || this.nextAds.length === 0 ? this.allAdsCompleted() : this.playCreativities();
          } else this.allAdsCompleted();
        } catch (l) {
          P.error(_, "fetchVastAds error:", l);
        }
      });
    }
    dispatchAdsEvent(e) {
      P.debug(_, "dispatchAdsEvent: ", e), this.eventEmitter.emit(e, new nt(e, this.currentAd));
    }
    ...
    adsVideoErrorListener(e) {
      var r, n;
      P.error(_, "adsVideoErrorListener: ", e), (r = this.adDisplayContainer) == null || r.hideAdVideoElement(), (n = this.adDisplayContainer) == null || n.clearAdVideoElement(), this.playCreativities();
    }
    resetQuartilesFired() {
      this.quartilesFired = {
        start: !1,
    ...
    addVideoListeners() {
      const e = this.adDisplayContainer.getVideoAdsElement();
      e && (Er.forEach(r => e.addEventListener(r, this.adsVideoEventsListener)), e.addEventListener("error", this.adsVideoErrorListener));
    }
  ...
  class hi {
    constructor(e) {
      ...
      g(this, "eventEmitter");
      g(this, "userRequestContext");
      g(this, "imaSdkSettings", new Ge());
      this.adDisplayContainer = e, this.eventEmitter = new jt();
    }
    addEventListener(e, r, n, s) {
      this.eventEmitter.addEventListener(e, r, n, s);
    }
    contentComplete() {}
    dispatchEvent(e) {
      return P.debug(Tr, "dispatchEvent", e), !0;
    }
    getSettings() {
    ...
    requestAds(e, r) {
      if (this.userRequestContext = r || void 0, !e.adTagUrl) {
        const s = new We(google.ima.AdError.ErrorCode.FAILED_TO_REQUEST_ADS, "AdManager is already defined or adTagUrl is not defined");
        this.eventEmitter.emit(google.ima.AdErrorEvent.Type.AD_ERROR, new $e(s));
        return;
      }
      this.adsManager = new vr(e, this.adDisplayContainer), this.adsManager.fetchAds().then(s => (this.adsManager = s, this.eventEmitter.emit(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, new Ct(s)))).catch(s => {
        const i = s.message || "Unable to retrive vmap files",
          l = new We(google.ima.AdError.ErrorCode.FAILED_TO_REQUEST_ADS, s.message || "Unable to retrive vmap files");
        return P.error(Tr, i, l), this.eventEmitter.emit(google.ima.AdErrorEvent.Type.AD_ERROR, new $e(l));
      });
    }
    destroy() {
      var e;
  ...
  class fi {
    ...
    setAdWillAutoPlay(e) {
      P.debug(Nt, `setAdWillAutoPlay [${e}]`);
    }
    setAdWillPlayMuted(e) {
      P.debug(Nt, `setAdWillPlayMuted [${e}]`);
    }
  ...
  function at() {
    ...
    Dr = 1;
    function t(i, l, o) {
      if (o === void 0 && (o = Array.prototype), i && typeof o.find == "function") return o.find.call(i, l);
      for (var c = 0; c < i.length; c++) if (Object.prototype.hasOwnProperty.call(i, c)) {
        var h = i[c];
        if (l.call(void 0, h, c, i)) return h;
      }
    }
    function e(i, l) {
      return l === void 0 && (l = Object), l && typeof l.freeze == "function" ? l.freeze(i) : i;
    }
    function r(i, l) {
      if (i === null || typeof i != "object") throw new TypeError("target is not an object");
      for (var o in l) Object.prototype.hasOwnProperty.call(l, o) && (i[o] = l[o]);
      return i;
    }
    var n = e({
        HTML: "text/html",
  ...
  function yr() {
    ...
    function h(u, a) {
      ...
      if (!(d instanceof a)) {
        let f = function () {};
        f.prototype = a.prototype, f = new f(), c(d, f), u.prototype = d = f;
      }
      d.constructor != u && (typeof u != "function" && console.error("unknown Class:" + u), d.constructor = u);
    }
    var p = {},
      E = p.ELEMENT_NODE = 1,
      v = p.ATTRIBUTE_NODE = 2,
      y = p.TEXT_NODE = 3,
      R = p.CDATA_SECTION_NODE = 4,
      C = p.ENTITY_REFERENCE_NODE = 5,
      T = p.ENTITY_NODE = 6,
      k = p.PROCESSING_INSTRUCTION_NODE = 7,
      j = p.COMMENT_NODE = 8,
      q = p.DOCUMENT_NODE = 9,
      J = p.DOCUMENT_TYPE_NODE = 10,
    ...
    S.prototype = {
      ...
      toString: function (u, a) {
        for (var d = [], f = 0; f < this.length; f++) Ve(this[f], d, u, a);
        return d.join("");
      },
      filter: function (u) {
    ...
    function U(u, a) {
      this._node = u, this._refresh = a, x(this);
    }
    function x(u) {
    ...
    U.prototype.item = function (u) {
      return x(this), this[u] || null;
    }, h(U, S);
    function G() {}
    function O(u, a) {
      for (var d = u.length; d--;) if (u[d] === a) return d;
    }
    function B(u, a, d, f) {
      if (f ? a[O(a, f)] = d : a[a.length++] = d, u) {
        d.ownerElement = u;
        var D = u.ownerDocument;
        D && (f && Qe(D, u, f), te(D, u, d));
      }
    }
    function F(u, a, d) {
      var f = O(a, d);
      if (f >= 0) {
        for (var D = a.length - 1; f < D;) a[f] = a[++f];
        if (a.length = D, u) {
          var L = u.ownerDocument;
          L && (Qe(L, u, d), d.ownerElement = null);
        }
      } else throw new N(b, new Error(u.tagName + "@" + d));
    }
    G.prototype = {
      length: 0,
      ...
      getNamedItem: function (u) {
        for (var a = this.length; a--;) {
          var d = this[a];
          if (d.nodeName == u) return d;
        }
      },
      setNamedItem: function (u) {
        var a = u.ownerElement;
        if (a && a != this._ownerElement) throw new N(w);
      ...
      getNamedItemNS: function (u, a) {
        for (var d = this.length; d--;) {
          var f = this[d];
          if (f.localName == a && f.namespaceURI == u) return f;
        }
        return null;
      }
    };
    ...
    I.prototype = {
      ...
      replaceChild: function (u, a) {
        be(this, u, a, ht), a && this.removeChild(a);
      },
      ...
      cloneNode: function (u) {
        return Bt(this.ownerDocument || this, this, u);
      },
      normalize: function () {
      ...
      lookupPrefix: function (u) {
        for (var a = this; a;) {
          var d = a._nsMap;
          if (d) {
            for (var f in d) if (Object.prototype.hasOwnProperty.call(d, f) && d[f] === u) return f;
          }
      ...
      lookupNamespaceURI: function (u) {
        for (var a = this; a;) {
          var d = a._nsMap;
          if (d && Object.prototype.hasOwnProperty.call(d, u)) return d[u];
          a = a.nodeType == v ? a.ownerDocument : a.parentNode;
        }
        return null;
      },
    ...
    c(p, I), c(p, I.prototype);
    function Ee(u, a) {
      if (a(u)) return !0;
      if (u = u.firstChild) do if (Ee(u, a)) return !0; while (u = u.nextSibling);
    }
    function ee() {
    ...
    function Ue(u, a, d) {
      if (u && u._inc) {
        u._inc++;
        var f = a.childNodes;
        if (d) f[f.length++] = d;else {
          for (var D = a.firstChild, L = 0; D;) f[L++] = D, D = D.nextSibling;
    ...
    function ae(u, a) {
      var d = a.previousSibling,
        f = a.nextSibling;
      return d ? d.nextSibling = f : u.firstChild = f, f ? f.previousSibling = d : u.lastChild = d, a.parentNode = null, a.previousSibling = null, a.nextSibling = null, Ue(u.ownerDocument, u), a;
    }
    function pe(u) {
      return u && (u.nodeType === I.DOCUMENT_NODE || u.nodeType === I.DOCUMENT_FRAGMENT_NODE || u.nodeType === I.ELEMENT_NODE);
    }
    function Ze(u) {
      return u && (he(u) || Pe(u) || de(u) || u.nodeType === I.DOCUMENT_FRAGMENT_NODE || u.nodeType === I.COMMENT_NODE || u.nodeType === I.PROCESSING_INSTRUCTION_NODE);
    }
    function de(u) {
    ...
    function re(u, a, d) {
      if (!pe(u)) throw new N(A, "Unexpected parent node type " + u.nodeType);
      if (d && d.parentNode !== u) throw new N(b, "child not in parent");
      if (!Ze(a) || de(a) && u.nodeType !== I.DOCUMENT_NODE) throw new N(A, "Unexpected node type " + a.nodeType + " for parent node type " + u.nodeType);
    }
    function dt(u, a, d) {
      var f = u.childNodes || [],
        D = a.childNodes || [];
      if (a.nodeType === I.DOCUMENT_FRAGMENT_NODE) {
        var L = D.filter(he);
        if (L.length > 1 || e(D, Pe)) throw new N(A, "More than one element or text in fragment");
        if (L.length === 1 && !ie(u, d)) throw new N(A, "Element in fragment can not be inserted before doctype");
      }
      if (he(a) && !ie(u, d)) throw new N(A, "Only one element can be added and only after doctype");
      if (de(a)) {
        if (e(f, de)) throw new N(A, "Only one doctype is allowed");
        var Y = e(f, he);
        if (d && f.indexOf(Y) < f.indexOf(d)) throw new N(A, "Doctype can only be inserted before an element");
        if (!d && Y) throw new N(A, "Doctype can not be appended since element is present");
      }
    }
    function ht(u, a, d) {
      var f = u.childNodes || [],
      ...
      if (a.nodeType === I.DOCUMENT_FRAGMENT_NODE) {
        var L = D.filter(he);
        if (L.length > 1 || e(D, Pe)) throw new N(A, "More than one element or text in fragment");
        if (L.length === 1 && !xe(u, d)) throw new N(A, "Element in fragment can not be inserted before doctype");
      }
      if (he(a) && !xe(u, d)) throw new N(A, "Only one element can be added and only after doctype");
      if (de(a)) {
        if (e(f, function (ve) {
          return de(ve) && ve !== d;
    ...
    function be(u, a, d, f) {
      re(u, a, d), u.nodeType === I.DOCUMENT_NODE && (f || dt)(u, a, d);
      var D = a.parentNode;
      if (D && D.removeChild(a), a.nodeType === K) {
        var L = a.firstChild;
        if (L == null) return a;
        var Y = a.lastChild;
      } else L = Y = a;
      var ce = d ? d.previousSibling : u.lastChild;
      L.previousSibling = ce, Y.nextSibling = d, ce ? ce.nextSibling = L : u.firstChild = L, d == null ? u.lastChild = Y : d.previousSibling = Y;
      do L.parentNode = u; while (L !== Y && (L = L.nextSibling));
      return Ue(u.ownerDocument || u, u), a.nodeType == K && (a.firstChild = a.lastChild = null), a;
    }
    function pt(u, a) {
      return a.parentNode && a.parentNode.removeChild(a), a.parentNode = u, a.previousSibling = u.lastChild, a.nextSibling = null, a.previousSibling ? a.previousSibling.nextSibling = a : u.firstChild = a, u.lastChild = a, Ue(u.ownerDocument, u, a), a;
    }
    ee.prototype = {
      nodeName: "#document",
      nodeType: q,
      ...
      insertBefore: function (u, a) {
        ...
        return be(this, u, a), u.ownerDocument = this, this.documentElement === null && u.nodeType === E && (this.documentElement = u), u;
      },
      removeChild: function (u) {
        return this.documentElement == u && (this.documentElement = null), ae(this, u);
      },
      replaceChild: function (u, a) {
      ...
      getElementById: function (u) {
        var a = null;
        return Ee(this.documentElement, function (d) {
          if (d.nodeType == E && d.getAttribute("id") == u) return a = d, !0;
        }), a;
      },
      getElementsByClassName: function (u) {
        ...
        return new U(this, function (d) {
          var f = [];
          return a.length > 0 && Ee(d.documentElement, function (D) {
            if (D !== d && D.nodeType === E) {
    ...
    W.prototype = {
      ...
      appendChild: function (u) {
        return u.nodeType === K ? this.insertBefore(u, null) : pt(this, u);
      },
    ...
    we.prototype = {
      ...
      replaceData: function (u, a, d) {
        var f = this.data.substring(0, u),
          D = this.data.substring(u + a);
    ...
    function Or(u, a, d) {
      ...
      for (var L = d.length; L--;) {
        var Y = d[L];
        if (Y.prefix === f) return Y.namespace !== D;
      }
      return !0;
    }
    function Ot(u, a, d) {
      ...
      switch (u.nodeType) {
        case E:
          ...
          if (!d && !u.prefix && u.namespaceURI) {
            for (var ye, Te = 0; Te < L.length; Te++) if (L.item(Te).name === "xmlns") {
              ye = L.item(Te).value;
              break;
            }
            if (!ye) for (var Ie = D.length - 1; Ie >= 0; Ie--) {
              var Se = D[Ie];
              if (Se.prefix === "" && Se.namespace === u.namespaceURI) {
                ye = Se.namespace;
                break;
              }
            }
            if (ye !== u.namespaceURI) for (var Ie = D.length - 1; Ie >= 0; Ie--) {
              var Se = D[Ie];
              if (Se.namespace === u.namespaceURI) {
                Se.prefix && (ve = Se.prefix + ":" + ce);
                break;
              }
            }
          }
          ...
          for (var Le = 0; Le < Y; Le++) {
            var me = L.item(Le);
            me.prefix == "xmlns" ? D.push({
              prefix: me.localName,
              namespace: me.value
            }) : me.nodeName == "xmlns" && D.push({
              prefix: "",
              namespace: me.value
            });
          }
          ...
          if (se || d && !/^(?:meta|link|img|br|hr|input)$/i.test(ce)) {
            if (a.push(">"), d && /^script$/i.test(ce)) for (; se;) se.data ? a.push(se.data) : Ve(se, a, d, f, D.slice()), se = se.nextSibling;else for (; se;) Ve(se, a, d, f, D.slice()), se = se.nextSibling;
            a.push("</", ve, ">");
          } else a.push("/>");
          return;
        case q:
        case K:
          for (var se = u.firstChild; se;) Ve(se, a, d, f, D.slice()), se = se.nextSibling;
          return;
        case v:
          return Ot(a, u.name, u.value);
        case y:
          return a.push(u.data.replace(/[<&>]/g, le));
        case R:
    ...
    function Bt(u, a, d) {
      ...
      switch (a.childNodes && (f.childNodes = new S()), f.ownerDocument = u, f.nodeType) {
        case E:
          var Y = a.attributes,
            ce = f.attributes = new G(),
            ve = Y.length;
          ce._ownerElement = f;
          for (var ye = 0; ye < ve; ye++) f.setAttributeNode(Bt(u, Y.item(ye), !0));
          break;
        case v:
          d = !0;
      }
      ...
      if (Object.defineProperty) {
        let u = function (a) {
          switch (a.nodeType) {
            ...
            case K:
              var d = [];
              for (a = a.firstChild; a;) a.nodeType !== 7 && a.nodeType !== 8 && d.push(u(a)), a = a.nextSibling;
              return d.join("");
            default:
              return a.nodeValue;
          }
...
`,
  ...
  function vi() {
    ...
    Nr = 1;
    var t = at().NAMESPACE,
      e = /[A-Z_a-z\xC0-\xD6\xD8-\xF6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/,
      r = new RegExp("[\\-\\.0-9" + e.source.slice(1, -1) + "\\u00B7\\u0300-\\u036F\\u203F-\\u2040]"),
      n = new RegExp("^" + e.source + r.source + "*(?::" + e.source + r.source + "*)?$"),
      s = 0,
      i = 1,
      l = 2,
      o = 3,
    ...
    y.prototype = {
      parse: function (A, b, w) {
        ...
        N.startDocument(), J(b, b = {}), R(A, b, w, N, this.errorHandler), N.endDocument();
      }
    };
    function R(A, b, w, N, S) {
      function U(W) {
        if (W > 65535) {
          ...
          var ne = 55296 + (W >> 10),
            we = 56320 + (W & 1023);
          return String.fromCharCode(ne, we);
        } else return String.fromCharCode(W);
      }
      function x(W) {
        var ne = W.slice(1, -1);
        return Object.hasOwnProperty.call(w, ne) ? w[ne] : ne.charAt(0) === "#" ? U(parseInt(ne.substr(1).replace("x", "0x"))) : (S.error("entity not found:" + W), W);
      }
      function G(W) {
        if (W > ee) {
      ...
      function O(W, ne) {
        for (; W >= F && (ne = Q.exec(A));) B = ne.index, F = B + ne[0].length, I.lineNumber++;
        I.columnNumber = W - B + 1;
      }
      for (var B = 0, F = 0, Q = /.*(?:\r\n?|\n)|.*$/g, I = N.locator, le = [{
          currentNSMap: b
        }], Ee = {}, ee = 0;;) {
        try {
          var te = A.indexOf("<", ee);
          if (te < 0) {
            if (!A.substr(ee).match(/^\s*$/)) {
              var Qe = N.doc,
                Ue = Qe.createTextNode(A.substr(ee));
              Qe.appendChild(Ue), N.currentElement = Ue;
            }
            return;
          }
          switch (te > ee && G(te), A.charAt(te + 1)) {
            case "/":
              var re = A.indexOf(">", te + 3),
                ae = A.substring(te + 2, re).replace(/[ \t\n\r]+$/g, ""),
                pe = le.pop();
              re < 0 ? (ae = A.substring(te + 2).replace(/[\s<].*/, ""), S.error("end tag name: " + ae + " is not complete:" + pe.tagName), re = te + 1 + ae.length) : ae.match(/\s</) && (ae = ae.replace(/[\s<].*/, ""), S.error("end tag name: " + ae + " maybe not complete"), re = te + 1 + ae.length);
              var Ze = pe.localNSMap,
                de = pe.tagName == ae,
                he = de || pe.tagName && pe.tagName.toLowerCase() == ae.toLowerCase();
              if (he) {
                if (N.endElement(pe.uri, pe.localName, ae), Ze) for (var Pe in Ze) Object.prototype.hasOwnProperty.call(Ze, Pe) && N.endPrefixMapping(Pe);
                de || S.fatalError("end tag name: " + ae + " is not match the current start tagName:" + pe.tagName);
              } else le.push(pe);
              re++;
              break;
            case "?":
              ...
              break;
            case "!":
              I && O(te), re = K(A, te, N, S);
              break;
            default:
              I && O(te);
              var ie = new V(),
                xe = le[le.length - 1].currentNSMap,
                re = T(A, te, ie, xe, x, S),
                dt = ie.length;
              if (!ie.closed && q(A, re, ie.tagName, Ee) && (ie.closed = !0, w.nbsp || S.warning("unclosed xml attribute")), I && dt) {
                for (var ht = C(I, {}), be = 0; be < dt; be++) {
                  var pt = ie[be];
                  O(pt.offset), pt.locator = C(I, {});
                }
                N.locator = ht, k(ie, N, xe) && le.push(ie), N.locator = I;
    ...
    function T(A, b, w, N, S, U) {
      function x(I, le, Ee) {
        w.attributeNames.hasOwnProperty(I) && U.fatalError("Attribute " + I + " redefined"), w.addValue(I, le.replace(/[\t\n\r]/g, " ").replace(/&#?\w+;/g, S), Ee);
      }
      for (var G, O, B = ++b, F = s;;) {
        var Q = A.charAt(B);
        switch (Q) {
          case "=":
            if (F === i) G = A.slice(b, B), F = o;else if (F === l) F = o;else throw new Error("attribute equal must after attrName");
            break;
          case "'":
          case '"':
            if (F === o || F === i) {
              if (F === i && (U.warning('attribute value must after "="'), G = A.slice(b, B)), b = B + 1, B = A.indexOf(Q, b), B > 0) O = A.slice(b, B), x(G, O, b - 1), F = h;else throw new Error("attribute value no end '" + Q + "' match");
            } else if (F == c) O = A.slice(b, B), x(G, O, b), U.warning('attribute "' + G + '" missed start quot(' + Q + ")!!"), b = B + 1, F = h;else throw new Error('attribute value must after "="');
            break;
          case "/":
            switch (F) {
              case s:
          ...
          case ">":
            switch (F) {
              ...
              case l:
                F === l && (O = G), F == c ? (U.warning('attribute "' + O + '" missed quot(")!'), x(G, O, b)) : ((!t.isHTML(N[""]) || !O.match(/^(?:disabled|checked|selected)$/i)) && U.warning('attribute "' + O + '" missed value!! "' + O + '" instead!!'), x(O, O, b));
                break;
              case o:
          ...
          default:
            if (Q <= " ") switch (F) {
              ...
              case c:
                var O = A.slice(b, B);
                U.warning('attribute "' + O + '" missed quot(")!!'), x(G, O, b);
              case h:
                F = p;
                break;
            } else switch (F) {
              case l:
                w.tagName, (!t.isHTML(N[""]) || !G.match(/^(?:disabled|checked|selected)$/i)) && U.warning('attribute "' + G + '" missed value!! "' + G + '" instead2!!'), x(G, G, b), b = B, F = i;
                break;
              case h:
                U.warning('attribute space is required"' + G + '"!!');
              case p:
                F = i, b = B;
                break;
              case o:
    ...
    function k(A, b, w) {
      for (var N = A.tagName, S = null, Q = A.length; Q--;) {
        var U = A[Q],
          x = U.qName,
          G = U.value,
          I = x.indexOf(":");
        if (I > 0) var O = U.prefix = x.slice(0, I),
          B = x.slice(I + 1),
          F = O === "xmlns" && B;else B = x, O = null, F = x === "xmlns" && "";
        U.localName = B, F !== !1 && (S == null && (S = {}, J(w, w = {})), w[F] = S[F] = G, U.uri = t.XMLNS, b.startPrefixMapping(F, G));
      }
      ...
      var le = A.uri = w[O || ""];
      if (b.startElement(le, B, N, A), A.closed) {
        if (b.endElement(le, B, N), S) for (O in S) Object.prototype.hasOwnProperty.call(S, O) && b.endPrefixMapping(O);
      } else return A.currentNSMap = w, A.localNSMap = S, !0;
    }
    function j(A, b, w, N, S) {
      if (/^(?:script|textarea)$/i.test(w)) {
        var U = A.indexOf("</" + w + ">", b),
          x = A.substring(b + 1, U);
        if (/[&<]/.test(x)) return /^script$/i.test(w) ? (S.characters(x, 0, x.length), U) : (x = x.replace(/&#?\w+;/g, N), S.characters(x, 0, x.length), U);
      }
      return b + 1;
    }
    function q(A, b, w, N) {
    ...
    function J(A, b) {
      for (var w in A) Object.prototype.hasOwnProperty.call(A, w) && (b[w] = A[w]);
    }
    function K(A, b, w, N) {
      var S = A.charAt(b + 2);
      switch (S) {
        ...
        default:
          ...
          if (G > 1 && /!doctype/i.test(x[0][0])) {
            var O = x[1][0],
              B = !1,
              F = !1;
            G > 3 && (/^public$/i.test(x[2][0]) ? (B = x[3][0], F = G > 4 && x[4][0]) : /^system$/i.test(x[2][0]) && (F = x[3][0]));
            var Q = x[G - 1];
            return w.startDTD(O, B, F), w.endDTD(), Q.index + Q[0].length;
          }
      }
      return -1;
    }
    ...
    V.prototype = {
      setTagName: function (A) {
        if (!n.test(A)) throw new Error("invalid tagName:" + A);
        this.tagName = A;
      },
      addValue: function (A, b, w) {
        if (!n.test(A)) throw new Error("invalid attribute:" + A);
    ...
    function H(A, b) {
      var w,
        N = [],
        S = /'[^']+'|"[^"]+"|[^\s<>\/=]+=?|(\/?\s*>|<)/g;
      for (S.lastIndex = b, S.exec(A); w = S.exec(A);) if (N.push(w), w[1]) return N;
    }
...
`);
    ...
    function p(T, k, j) {
      if (!T) {
        if (k instanceof E) return k;
        T = k;
      }
      var q = {},
        J = T instanceof Function;
      j = j || {};
      function K(oe) {
        var V = T[oe];
    ...
    E.prototype = {
      ...
      startElement: function (T, k, j, q) {
        var J = this.doc,
          K = J.createElementNS(T, j || k),
          oe = q.length;
      ...
      processingInstruction: function (T, k) {
        var j = this.doc.createProcessingInstruction(T, k);
        this.locator && v(this.locator, j), C(this, j);
      },
      ignorableWhitespace: function (T, k, j) {},
      characters: function (T, k, j) {
        if (T = R.apply(this, arguments), T) {
          if (this.cdata) var q = this.doc.createCDATASection(T);else var q = this.doc.createTextNode(T);
          this.currentElement ? this.currentElement.appendChild(q) : /^\s*$/.test(T) && this.doc.appendChild(q), this.locator && v(this.locator, q);
        }
      },
      ...
      comment: function (T, k, j) {
        T = R.apply(this, arguments);
        var q = this.doc.createComment(T);
      ...
      startDTD: function (T, k, j) {
        var q = this.doc.implementation;
        if (q && q.createDocumentType) {
          var J = q.createDocumentType(T, k, j);
          this.locator && v(this.locator, J), C(this, J), this.doc.doctype = J;
        }
      },
      warning: function (T) {
...
@` + (T.systemId || "") + "#[line:" + T.lineNumber + ",col:" + T.columnNumber + "]";
    ...
    function R(T, k, j) {
      return typeof T == "string" ? T.substr(k, j) : T.length >= k + j || k ? new java.lang.String(T, k, j) + "" : T;
    }
...
/* Built on 2025-05-27T07:52:45.028Z */
